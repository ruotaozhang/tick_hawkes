...
class ThreadPool:
    """Minimal replacement for tick.base.ThreadPool"""
...
class HawkesConditionalLaw(Base):
    """V2: Enhanced version with additional numba optimizations for speed.
    ...
    * :math:`f_{ij}` the mark functions supposed to be piece-wise constant
    ...
    def incremental_fit(self, realization, T=None, compute=True):
        """V2: Enhanced incremental_fit with additional numba optimizations.
